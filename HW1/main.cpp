...
int main()
{
	...
	std::cout << "HOCAM MERHABALAR.ODEVI USER(BEYAZ) VS COMPUTER(SIYAH) OLARAK ANLAMISTIM BEN O YUZDEN SATRANC MOTORU YAZMISIM(COK ZEKI DEGIL AMA DOGRU HAMLELERI YAPIYOR)"
	" AMA SOYLE KI BIRAZ GUNCELLEME YAPTIM ISTEDIGINIZ SEKILDE OYNAYABILIYOSUNUZ KENDINIZ OYNAMAK ISTERSENIZ ISTEDIGINIZ TARAFIN HAMLESINI GIRIN BILGISAYAR OYNASIN ISTERSENIZ"
	" HERHANGI BIR TUSA BASIP ENTER GIRERSENIZ BILGISAYAR OYNUYOR.KUSURA BAKMAYIN YANLIS ANLAMISIM ODEVI \n\n\n\n\n "<<std::endl;
